...
const RiskScreen = ({ goto, addToast, params }) => {
  ...
  const [klass, setKlass] = useState("high");
  const [factors, setFactors] = useState(MOCK_FACTORS);
  const [loading, setLoading] = useState(false);
  const [docId] = useState(params?.docId || null);

  const trend = [0.45, 0.48, 0.5, 0.52, 0.51, 0.55, 0.58, 0.6, 0.59, 0.61, 0.62, score];
    ...
    <div className="stagger">
      <div className="page-head">
        <div>
          ...
          <p>Estimated probability of unplanned hospitalization within 30 days, with the top features driving the prediction.</p>
        </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 0.9fr) 1.1fr", gap: 14 }}>
            <GlassCard strong xl style={{ padding: 28, position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <RiskGauge score={score} klass={klass} />
